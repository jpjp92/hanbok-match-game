...
const App: React.FC = () => {
  ...
  return (
    ...
    <div className="h-dvh flex flex-col items-center py-4 px-3 md:px-8 font-serif text-k-text overflow-hidden relative select-none bg-gradient-to-br from-[#F8F5F2] to-[#eeeae6]">
      ...
      <footer className="hidden md:block fixed bottom-4 text-stone-400 text-xs font-sans tracking-wide mix-blend-multiply pointer-events-none">
        DESIGNED FOR HANBOK LOVERS
      </footer>
